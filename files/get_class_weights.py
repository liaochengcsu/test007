...
image_dir = r"F:\hn_gf2\train_data\result_256\gt_train"
...
def median_frequency_balancing(image_files=image_files, num_classes=12):
    ...
    # print("total pix:{}".format(total_pixels))
...
if __name__ == "__main__":
    print(median_frequency_balancing(image_files, num_classes=7))
    # print(ENet_weighing(image_files, num_classes=7))